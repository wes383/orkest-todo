...
const zh = {
  ...
  "calendar.rescheduledBody": "「{title}」改期到 {date}",
  "calendar.collapse": "收起",
  "calendar.monthLabel": "月份",
  "calendar.yearLabel": "年份",
  "calendar.pop.list": "清单",
  "calendar.pop.edit": "编辑",
  "calendar.pop.delete": "删除",
  "calendar.hideDone": "隐藏已完成",
  "calendar.showDone": "显示已完成",
  "calendar.pop.markDone": "标记完成",
  "calendar.pop.markUndone": "标记未完成",
  "calendar.pop.star": "加星",
  "calendar.pop.unstar": "取消加星",
  ...
  "settings.autostartHint": "登录系统后自动打开 Orkest Todo。",
  "settings.closeToTray": "关闭窗口时最小化到托盘",
  "settings.quitStopsFocus": "退出应用时结束进行中的专注",
  ...
  "focus.log.yearHeat": "专注热力图",
  "focus.log.yearHeat.prevYear": "上一年",
  "focus.log.yearHeat.nextYear": "下一年",
  "focus.log.yearHeat.less": "少",
  "focus.log.yearHeat.more": "多",
  "focus.log.weeks": "8 周",
...
const en: Record<MessageKey, Message> = {
  ...
  "calendar.rescheduledBody": "“{title}” moved to {date}",
  "calendar.collapse": "Show less",
  "calendar.monthLabel": "Month",
  "calendar.yearLabel": "Year",
  "calendar.pop.list": "List",
  "calendar.pop.edit": "Edit",
  "calendar.pop.delete": "Delete",
  "calendar.hideDone": "Hide completed",
  "calendar.showDone": "Show completed",
  "calendar.pop.markDone": "Mark done",
  "calendar.pop.markUndone": "Mark undone",
  "calendar.pop.star": "Star",
  "calendar.pop.unstar": "Remove star",
  ...
  "settings.autostartHint": "Open Orkest Todo automatically when you sign in.",
  "settings.closeToTray": "Minimize to tray when closing",
  "settings.quitStopsFocus": "End focus when quitting the app",
  ...
  "focus.log.yearHeat": "Focus heatmap",
  "focus.log.yearHeat.prevYear": "Previous year",
  "focus.log.yearHeat.nextYear": "Next year",
  "focus.log.yearHeat.less": "Less",
  "focus.log.yearHeat.more": "More",
  ...
  "cmd.screen.calendar": "Go to: Calendar",
