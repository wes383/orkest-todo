...
const zh = {
  ...
  "focus.log.best": "个人最佳",
  "focus.log.bestStretch": "最长单次",
  "focus.log.bestDay": "最佳一天",
  ...
  "focus.log.byList.hint": "选定后，整份统计只看这个清单。",
  "focus.log.when": "你的高效时段",
  "focus.log.allHistory": "全部历史",
  "focus.log.when.none": "记录还太少，看不出一天的形状。",
  "focus.log.when.peak": "最强的一小时是 {from}–{to}，累计 {value}。",
  "focus.log.milestones": "里程碑",
...
const en: Record<MessageKey, Message> = {
  ...
  /* ── Focus · durations, clocks and hour names ────────────── */
  "focus.duration.minutes": ({ n }) =>
    `${n} ${plural(Number(n), "minute", "minutes")}`,
  "focus.duration.hours": ({ n }) =>
    `${n} ${plural(Number(n), "hour", "hours")}`,
  ...
  "focus.log.bestStretch": "Longest stretch",
  "focus.log.bestDay": "Best day",
  ...
  "focus.log.byList.hint": "Pick one to read every figure against it.",
  "focus.log.when": "When you’re useful",
  "focus.log.allHistory": "All history",
  "focus.log.when.none": "Not enough logged yet to see a shape to the day.",
  "focus.log.when.peak":
    "Your strongest hour is {from}–{to}, holding {value} of useful time.",
  "focus.log.milestones": "Milestones",
