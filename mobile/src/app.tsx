...
const STRINGS = {
  zh: {
    ...
    retentionNote:
      "桌面端至少每 6 天打开一次。云端只保留约一周，逾期未同步的记录可能会永久丢失。",
    codeLabel: "同步码",
    connect: "连接",
    connecting: "连接中…",
    reconfigure: "更改同步码",
  ...
  en: {
    ...
    retentionNote:
      "Open the desktop at least once every 6 days. The cloud keeps a stretch for about a week; a stretch not synced by then may be lost for good.",
    codeLabel: "Sync code",
    connect: "Connect",
  ...
  return (
    <div className="page">
      ...
      >
        ...
        {/* The one rule on this page whose cost is data rather than a retype.
            Said here because this screen is both the first code and settings,
            and read here because it sits in the flow of the field below. */}
        <p className="note">{strings.retentionNote}</p>
